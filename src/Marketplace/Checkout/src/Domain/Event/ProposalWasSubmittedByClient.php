...
final class ProposalWasSubmittedByClient extends DomainEvent
{
    ...
    private function __construct(
        ...
        $this->proposer = $clientId;
        $this->content = $content;

        parent::__construct($this->checkout->value(), $eventId, $occurredOn);
    }

    public static function fromPayload(array $payload, string $occurredOn): ProposalWasSubmittedByClient
    {
    ...
    public static function forCheckout(ClientProposal $proposal, CheckoutId $checkout): ProposalWasSubmittedByClient
    {
