...
final class FindClientsPendingCheckouts extends ApiController
{
    /**
     * @Route(
     *     "/client/{clientId}/checkouts/pending",
     *     methods={"GET"}
     * )
     */
    public function __invoke(PendingCheckoutRepository $readRepository, string $clientId): Response
    {
        $checkouts = $readRepository->findPendingByClient($clientId);
